...
McNetworkMenu is GPL-3.0-or-later. The complete license text is in `COPYING`; preserve it and its README reference when adding or updating project documentation.
